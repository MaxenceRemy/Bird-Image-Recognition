...
async def add_image(
    ...
    try:
        ...
        if is_unknown:
            ...
            return {"status": "Image uploaded to GitHub", "url": "Github is not configured"}
        elif is_new_species:
            new_class_path = os.path.join(dataset_raw_path, f"train/{species}")
...
async def train(
    ...
    try:
        return "This route is not active yet because there is no training container yet/"
