...
class testSingleInferenceImage(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        """
        logger.info(f"Début de test unitaire de predictClass.py")
        test_path = "./data/test"
    ...
    def test_01_main(self):
        ...
        self.assertTrue(bool(class_name.strip()), f"La classe prédite par le modèle est vide.") 
        self.assertTrue( 0 <= confidence <= 1, f"Le score de la prédiction n'est pas compris dans l'intervalle [0;1].") 
    ...
    def tearDownClass(cls):
        ...
        """
        logger.info(f"Fin de test unitaire de predictClass.py")
